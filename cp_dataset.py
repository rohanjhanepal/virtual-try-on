...
class CPDataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        self.res_path = osp.join(opt.dataresult, opt.datamode)
    ...
    def __getitem__(self, index):
        ...
        if self.stage == 'GMM':
            ...
            c = Image.open(osp.join(self.res_path, 'warp-cloth', im_name))    # c_name, if that is used when saved
            cm = Image.open(osp.join(self.res_path, 'warp-mask', im_name)).convert('L')    # c_name, if that is used when saved
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataresult", default="result")
